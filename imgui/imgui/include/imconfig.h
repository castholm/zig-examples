...
// and have extra stuff included. #define IMGUI_INCLUDE_IMGUI_USER_H #define
// IMGUI_USER_H_FILENAME         "my_folder/my_imgui_user.h"

//---- Pack vertex colors as BGRA8 instead of RGBA8 (to avoid converting from
// one to another). Need dedicated backend support.
...
// "my_folder/stb_sprintf.h"    // only used if IMGUI_USE_STB_SPRINTF is
...
// install'. #define IMGUI_ENABLE_FREETYPE
...
// licensed under CeCILL-C Free Software License Agreement) #define
// IMGUI_ENABLE_FREETYPE_PLUTOSVG #define IMGUI_ENABLE_FREETYPE_LUNASVG
...
// ImDrawCmd* cmd, void* my_renderer_user_data); #define ImDrawCallback
// MyImDrawCallback
