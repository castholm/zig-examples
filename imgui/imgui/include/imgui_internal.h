...
// intent to add more aggressive ones in the code. #define IMGUI_DEBUG_PARANOID
...
enum ImGuiItemFlagsPrivate_ {
    ...
    ImGuiItemFlags_Disabled =
        1
        << 10, // false     // Disable interactions (DOES NOT affect visuals. DO
...
struct ImGuiListClipperRange {
    ...
    FromPositions(float y1, float y2, int off_min, int off_max) {
        ImGuiListClipperRange r = {(int)y1,
                                   (int)y2,
                                   true,
                                   (ImS8)off_min,
                                   (ImS8)off_max};
...
struct IMGUI_API ImGuiMultiSelectTempData {
    ...
    ImVec2 BackupCursorMaxPos;
    ImGuiSelectionUserData
        LastSubmittedItem; // Copy of last submitted item data,
...
struct ImGuiContext {
    ...
    float
        WindowsBorderHoverPadding; // Padding around resizable windows for which
